...
const Entry = () => {
    ...
    return (
        <div className="w-full h-screen px-[9rem] bg-cover bg-no-repeat bg-center  bg-[url('https://assets.nflxext.com/ffe/siteui/vlv3/729ce5c2-d831-436a-8c9d-f38fea0b99b3/web/AZ-en-20241209-TRIFECTA-perspective_a09d6162-5992-4ec3-a2b8-9081ca80c5b0_large.jpg')] bg-black/75 bg-blend-overlay ">
            <div className="flex items-center justify-between pt-5">
                ...
                <div className='flex items-center gap-2 h-[35px]  '>
                    ...
                    <button className='bg-[#e50914] hover:bg-[#ce272ffb] transition duration-100 ease-in px-4 h-full text-white font-semibold rounded'>Sign In</button>
                    {/* <h1 className='font-inter font-bold text-[60px] text-white leading-[65px] text-center'>
                        {t('entryTitle')}
                    </h1> */}
                </div>
            </div>
            <div className="w-[588px] h-307 mx-auto pt-[90px] text-center text-white">
                <h1 className="text-[67px] font-bold leading-[80px]">Unlimited movies, TV shows, and more</h1>
                <p className="font-roboto text-[20px]   ">Starts at EUR 7.99. Cancel anytime.</p>
                <h3 className="font-medium font-roboto text-[17px] mt-[25px] ">Ready to watch? Enter your email to create or restart your membership.</h3>
